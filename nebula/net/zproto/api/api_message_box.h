...
//// RawData消息会转换成MessageData
//template <class T>
//std::shared_ptr<CImPduMessageBoxed<T>> ToMessageDataBoxed() {
//  auto message_boxed = std::make_shared<CImPduMessageBoxed<T>>();
//  message_boxed->CopyHeaderFrom(*this);
//  if ((*message_boxed)->ParseFromArray(message_.GetRawData(), message_.GetRawDataLength())) {
//    return message_boxed;
//  } else {
//    return std::shared_ptr<CImPduMessageBoxed<T>>();
//  }
//}
//
//CImPduBase* Clone() const override {
//  CImPduRawDataBoxed* clone = new CImPduRawDataBoxed();
//  clone->CopyHeaderFrom(*this);
//  clone->message_.ParseFromArray(this->message_.GetRawData(), this->message_.GetRawDataLength());
//  return clone;
//}

//struct ZRpcRequest : public PackageMessage {
//  virtual ~ZRpcRequest() = default;
//};
//
//typedef std::shared_ptr<ZRpcRequest> ZRpcRequestPtr;
//
//struct ZRpcResponse : public PackageMessage {
//  virtual ~ZRpcResponse() = default;
//};
//
//typedef std::shared_ptr<ZRpcResponse> ZRpcResponsePtr;
...
#endif // NEBULA_NET_HANDLER_API_API_MESSAGE_BOXED_H_
