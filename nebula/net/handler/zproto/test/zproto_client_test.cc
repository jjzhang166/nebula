...
protected:
  bool Initialize() override {
    RegisterService("zproto_client_test", "rpc_client", "zrpc");
...
public:
  ...
  static int OnDataReceived(nebula::ZProtoPipeline* pipeline, std::shared_ptr<BasicSyncMessage> message_data) {
