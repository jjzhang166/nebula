...
struct ZProtoEventCallback {
  using NewConnectionFunc = std::function<int(nebula::TcpServiceBase*, nebula::ZProtoPipeline*)>;
  using DataReceivedFunc = std::function<int(nebula::ZProtoPipeline*, std::shared_ptr<PackageMessage>)>;
  using ConnectionClosedFunc = std::function<int(nebula::TcpServiceBase*,  nebula::ZProtoPipeline*)>;
